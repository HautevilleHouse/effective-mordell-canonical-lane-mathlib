/-!
# effective-mordell Lean migration boundary
...
`effective_mordell/SourcePackage.lean`.
...
def sourceRepository : String := "effective-mordell"
def sourceUrl : String := "https://github.com/HautevilleHouse/effective-mordell"
def sourceDescription : String := "Canonical-lane closure package for the Effective Mordell Conjecture: admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["effective-mordell", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
