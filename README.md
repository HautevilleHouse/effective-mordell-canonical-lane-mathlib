# Effective Mordell Conjecture — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Effective Mordell Conjecture.

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/effective-mordell-mathlib.git
cd effective-mordell-mathlib
lake exe
lake build
```
